...
the current checkpoint translates source language sentences into target language.
...
from tensorflow_seq2seq import data_utils
from tensorflow_seq2seq import seq2seq_model
